...
public class EmployeeController {
     ...
     */
    @GetMapping(path = "/all")
    public @ResponseBody List<Employee> getAllEmployees(@RequestParam("page") int page, @RequestParam("size") int size, @RequestParam("sortField") String sortField, @RequestParam("sortDirection") String sortDirection, @RequestParam("searchTerm") String searchTerm) {
